...
public class Week2CardGame {
    ...
    public static void main(String[] args) {
        ...
        // value and suit are needed from the user and can be access by object of the card class
        Card[] deck = new Card[4]; //4 cards // declaration of array of objects
 ...
 //           deck[i]=s1;
        ...
        System.out.println("your 4 cards detail: ");
        for(int i=0;i<deck.length;i++){
